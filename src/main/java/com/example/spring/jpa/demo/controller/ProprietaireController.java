...
import com.example.spring.jpa.demo.service.ProprietaireService;
...
public class ProprietaireController {
  ...
  @PostMapping
  public ResponseEntity<Void> creerNouveauProprio(
  ...
  @DeleteMapping("/{id}")
  public ResponseEntity<Void> supprimerProprietaire(@PathVariable Long id) throws Exception {
